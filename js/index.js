...
function initialize_footer_text_map_map() {
    ...
    var mapOptions = {
        ...
        center: new google.maps.LatLng(-6.286016080214747, 106.82954412394724),
    ...
    var myLatLng = new google.maps.LatLng(-6.286016080214747, 106.82954412394724);
...
$action_text_timer_countdown.countdown('2022/05/13 23:59:59', function (event) {
...
//------------------------------------------------------------------------------------
$('#subscribe-text-img--0-form').validate({
    onfocusout: false,
    onkeyup: false,
    rules: {
    },
...
$('#subscribe-text-img--0-form').submit(function () {
    // submit the form
    //data area
    var data = [];
    ...
    if ($(this).valid()) {
        ...
        $.ajax({
            ...
            processData: false,
            success: function () {
                $('#subscribe-text-img--0-form').find('[type=submit]').button('complete');
            },
            error: function () {
                $('#subscribe-text-img--0-form').find('[type=submit]').button('reset');
            }
        });
    } else {
